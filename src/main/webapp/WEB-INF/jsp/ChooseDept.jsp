...
<table class="layui-table" lay-data="{width: 485,    url:'ChooseDepts',  id:'idTests' }" lay-filter="huanzhemlists">
  <thead>
    <tr>
      <!-- <th lay-data="{type:'checkbox', fixed: 'left'}"></th> -->
<!--       <th lay-data="{field:' ',   sort: true, fixed: true}">采购员id</th> -->
       <th lay-data="{field:'ownerid',   sort: true, fixed: true}">所有者</th>
...
layui.use('table', function(){
  ...
  table.on('tool(huanzhemlists)', function(obj){
    ...
    if(obj.event === 'choices'){
      ...
      parent.$('#huozhuhz').val(data.deptname);
      parent.$('#huozhuhzid').val(data.ownerid);
